...
<html lang="en">
    ...
    <style>
        #navigation {
          background: #FB962E;  /* fallback for old browsers */
        }
        #header {
  
            background: #22223b;  /* fallback for old browsers */
        ...
        #top-header {
            ...
            background: #161627;  /* fallback for old browsers */
			...
			<div id="top-header">
				<div class="container">
					<ul class="header-links pull-left">
						...
						<li><a href="#"><i class="fa fa-envelope-o"></i> hetvi@gmail.com</a></li>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="header-logo">
								<a href="#" class="logo">
								<font style="font-style:normal; font-size: 33px;color: aliceblue;font-family: Poppins">
                                        Style Hub
                                    </font>
